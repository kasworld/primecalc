...
fn multi_find(primes_to_find :prime_vec::Element, worker_count :usize) {
    ...
    primes.load(); 
    println!("after load {:?}", Instant::now()-begin);

    primes = prime_vec::multi_make_to(primes, primes_sqrt, worker_count);
    println!("after multi_make_to {} {} {:?}",primes.len(), primes.last(), Instant::now()-begin);
    ...
    println!("after search {} {} {:?}",primes.len(), primes.last(), Instant::now()-begin);

    primes.save();
    println!("after save {:?}", Instant::now()-begin);
}
...
fn single(primes_to_find :prime_vec::Element) {
    ...
    println!("after simple_make_to {} {} {:?}",primes.len(), primes.last(), Instant::now()-begin);
