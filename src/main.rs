...
fn multi2() {
    ...
    primes = prime_vec::multi_make_to(primes, 0xfffffff, 20);
    let now = Instant::now();
...
// fn multi() {
//     let mut primes = prime_vec::PrimeVec::new().simple_make_to(0xffff);
//     // primes.simple_make_to(0xffff);
//     let prime_to_find = primes.last();
//     let worker_count :usize = 20;
//     let pend = 0xfffffff;
